...
LABEL HeadRatLinuxLive 
    ...
    APPEND root=/dev/sr0 ro init=/sbin/init fbcon=font:SUN8x16 quiet splash splash 
    TEXT HELP
...
LABEL HeadRatLinuxInstaller
    ...
    KERNEL /images/bzImage
    APPEND root=/dev/sr0 ro init=/root/install-sda.sh fbcon=font:SUN8x16 quiet splash splash
    TEXT HELP
...
LABEL HeadRatLinuxViaInit
    ...
    KERNEL /images/bzImage
    APPEND root=/dev/sda2 rw init=/sbin/init fbcon=font:SUN8x16 quiet splash splash
    TEXT HELP
