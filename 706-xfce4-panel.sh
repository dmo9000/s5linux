...
set -e
#
# xfce4-panel3-2.4.103
PKGID=S5LXxfce4-panel
PKG=xfce4-panel
VERSION=4.14.0
PKGNAME=${PKG}-${VERSION}
NPROC=`nproc`
...
#/usr/bin/meson --buildtype=plain --prefix=/usr --libdir=/usr/lib64 --libexecdir=/usr/libexec --bindir=/usr/bin --sbindir=/usr/sbin --includedir=/usr/include --datadir=/usr/share --mandir=/usr/share/man --infodir=/usr/share/info --localedir=/usr/share/locale --sysconfdir=/etc --localstatedir=/var --sharedstatedir=/var/lib --wrap-mode=nodownload --auto-features=enabled . x86_64-headrat-linux-gnu -Dman=true -Ddtrace=true -Dsystemtap=true -Dxfce4-panel_doc=true -Dinstalled_tests=true -Dfam=true --default-library=both
